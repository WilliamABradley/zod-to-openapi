...
class OpenAPIGenerator {
    ...
    getResponseHeaders(headers) {
        if (!(0, zod_is_type_1.isZodType)(headers, 'ZodObject')) {
            return headers;
        }
    ...
    toOpenAPIObjectSchema(zodSchema, isNullable, defaultValue) {
        ...
        if (!extendedFrom) {
            return Object.assign(Object.assign(Object.assign(Object.assign({}, this.mapNullableType('object', isNullable)), { default: defaultValue, properties }), (required.length > 0 ? { required } : {})), (unknownKeysOption === 'strict'
        ...
        const additionalProperties = Object.fromEntries(Object.entries(properties).filter(([key, type]) => {
            return !(0, lodash_1.objectEquals)(propsOfParent[key], type);
        }));
        const additionallyRequired = required.filter(prop => !keysRequiredByParent.includes(prop));
        const objectData = Object.assign(Object.assign(Object.assign(Object.assign({}, this.mapNullableType('object', isNullable)), { default: defaultValue, properties: additionalProperties }), (additionallyRequired.length > 0
